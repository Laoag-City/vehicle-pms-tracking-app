...
class AddNewVehicleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'year_model' => "bail|nullable|integer|min:1950|max:$yearNow",
            'plate_number' => ['bail', 'required', 'string', 'min:1', 'max:20', new AlphaNumSpace,'unique:vehicles,plate_number'],
            'serial_number' => ['bail', 'required', 'string', 'min:1', 'max:30', new AlphaNumDashSpaceDot,'unique:vehicles,serial_number']
        ];
    }
}
